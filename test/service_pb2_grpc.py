...
class FileDecompressStub(object):
    """服务定义
    """
...
def add_FileDecompressServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'filedecompress.FileDecompress', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('filedecompress.FileDecompress', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class FileDecompress(object):
    """服务定义
    """
